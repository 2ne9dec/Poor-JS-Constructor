  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options2 = this.options,
          ...
          img = _this$options2.imageStyles;
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" alt=").concat(alt, " style=\"").concat((0, _utils.css)(img), "\" />"), (0, _utils.css)(styles));
    }
  }]);
...
},{"../utils":"utils.js"}],"assets/image.png":[function(require,module,exports) {
...
var model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'Узнаешь как работают принципы SOLID и ООП в JavaScript', 'JavaScript - это просто, интересно. Научитесь создавать людые UI своими руками'], {
  styles: {
...
exports.model = model;
},{"./classes/blocks":"classes/blocks.js","./assets/image.png":"assets/image.png"}],"classes/sidebar.js":[function(require,module,exports) {
"use strict";
